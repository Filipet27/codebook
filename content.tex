...
\subsection{Funcao pronta}
\lstinputlisting{busca/funcaopronta.cpp}

\subsection{Busca Binária Padrão}
\lstinputlisting{busca/busca_binaria.cpp}

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% Soma de Prefixos %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section{Soma de Prefixos}

\subsection{Soma de prefixos base}
\lstinputlisting{soma_prefixos/base.cpp}

\subsection{Soma de prefixos Bidirecional(Prob Arvore)}
\lstinputlisting{soma_prefixos/bidirecional.cpp}
...
\subsection{Two pointers(  percorrendo esq=0 e dir=n-1 )}
\lstinputlisting{two_pointers/children.cpp}
...
\subsection{codigo base bitset}
\lstinputlisting{bitset/bitset.cpp}

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% STL  %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section{Estruturas STL}

\subsection{Resumo geral STL}
\lstinputlisting{STL/introducao.cpp}
...
\subsection{Absoluto}
\lstinputlisting{matematica/absoluto.cpp}
